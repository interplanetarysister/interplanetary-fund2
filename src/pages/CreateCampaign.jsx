      ...
      <div className="bg-white rounded-2xl border border-stone-200/70 p-6 shadow-sm space-y-5">
        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-stone-500">Goal: <span className="font-semibold text-stone-900">${Number(form.goal_amount || 0).toLocaleString()}</span>{form.end_date && ` · Ends ${form.end_date}`}</p>
