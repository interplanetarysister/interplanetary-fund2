  ...
  return (
    <div className="campaign-quest deep-space max-w-3xl mx-auto w-full min-w-0 px-4 sm:px-6 py-8 sm:py-12 overflow-x-hidden rounded-[2rem] sm:my-6">
      ...
      <div className="glass-panel rounded-[1.75rem] p-4 sm:p-6 shadow-[0_20px_70px_rgba(2,6,23,.45)] space-y-5 min-w-0">
        ...
        {step === 2 && (<>
          <div className="rounded-2xl border border-violet-300/25 bg-violet-500/10 p-4 sm:p-5 space-y-2"><div><p className="text-xs font-bold uppercase tracking-[.18em] text-violet-300">Your signal</p><Label className="quest-label text-base">Sum it up in one line</Label></div><Input className="quest-input" placeholder="What are you trying to make happen?" value={form.summary} onChange={(e) => set("summary", e.target.value)} /><p className="text-xs text-slate-400">Your words stay yours. The AI builds around them.</p></div>
