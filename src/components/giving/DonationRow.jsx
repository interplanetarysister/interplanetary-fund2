  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-stone-100 last:border-0">
      <div className="min-w-0">
        <Link to={`/campaign/${donation.campaign_id}`} className="text-sm font-medium text-stone-900 hover:text-orange-600 transition-colors block truncate">
      ...
      <div className="flex items-center gap-3 shrink-0">
        <span className="text-sm font-semibold text-stone-900">
          ...
          {donation.is_recurring && <Repeat className="w-3 h-3 inline ml-1 text-orange-500" />}
        </span>
